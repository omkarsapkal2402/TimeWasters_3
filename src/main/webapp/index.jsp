                ...
                <div class="single-slider slider-height d-flex align-items-center" data-background="assets/img/hero/h1_hero.jpg">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-6 col-lg-9 col-md-10">
                                <div class="hero__caption">
                                    <h1>Finding The Right One Isn't Hard !!  </h1>
                                </div>
                            </div>
                        </div>
                        <!-- Search Box -->
                        <div class="row">
                            <div class="col-xl-8">
                                <!-- form -->
                                <form action="Emp_Controller" class="search-box",>
                                    <div class="input-form">
                                        <input name="job" type="text" placeholder="Find the Best Employee Here..">
                                    </div>
                                    ...
                                    <div class="search-form">
                                        <input type="submit"  style="padding: 34.5px 40px" class="btn head-btn1" value="Find Employee">
                                    </div>	
                                </form>	
                            </div>
                        </div>
